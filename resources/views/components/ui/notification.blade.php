...
<div x-data="{
    ...
    addNotification({ variant = 'info', sender = null, title = null, message = null, duration = null, sound = null, position = null }) {
        const id = Date.now()
        ...
        // override soundEffect jika diberikan
        if (sound !== null) {
    ...
    x-on:notify.window="addNotification({
            ...
            duration: $event.detail[0].duration,
            sound: $event.detail[0].sound,
    ...
    <div x-on:mouseenter="$dispatch('pause-auto-dismiss')" x-on:mouseleave="$dispatch('resume-auto-dismiss')"
        x-bind:class="`pointer-events-none fixed z-50 flex flex-col gap-2 ` + positionClasses()">
